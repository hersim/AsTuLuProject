...
namespace AsTuLuWebProject_prog.DAL
{
    public class BookRepository : IBookRepository
    {
        ...
        public List<BookModel> ListBooks()
        {
            ...
            {
                return context.Book.Select(x => new BookModel(x)).ToList();
            }
        }

        List<BookModel> IBookRepository.ListHighestRatingBooks()
        {
            using (AsTuLusEntities context = new AsTuLusEntities())
            {
                return context.Book.OrderBy(x => x.Score).Select(x => new BookModel(x)).ToList();
            }
        }

        List<BookDisplay> IBookRepository.GetListOfBooks(int pageNumber, string firstOption, string secondOption, string thirdOption, int? userId)
        {
            using (AsTuLusEntities context = new AsTuLusEntities())
            {
        ...
        List<BookModel> IBookRepository.ListBooks()
        {
        ...
        private List<Book> ListBooksByEditor(AsTuLusEntities context, int pageCount, string firstOption, string secondOption, string thirdOption)
        {
            List<Book> listBook = new List<Book>();
        ...
        private List<Book> ListBooksByCategory(AsTuLusEntities context, int pageCount, string firstOption, string secondOption, string thirdOption)
        {
            List<Book> fetch;
