...
ko.utils = new (function () {
    ...
    // Note that, since IE 10 does not support conditional Comment, the following logic only detects IE < 10.
    ...
    ko.virtualElements = {
        ...
        prepend: function(containerNode, nodeToPrepend) {
            if (!isStartComment(containerNode)) {
                ...
                // Start Comment must always have a parent and at least one following sibling (the end comment)
        ...
        insertAfter: function(containerNode, nodeToInsert, insertAfterNode) {
            if (!insertAfterNode) {
                ...
                // Children of start Comment must always have a parent and at least one following sibling (the end comment)
...
(function () {
    ...
    // Anonymous templates can't be rewritten. Give a nice error mMessage if you try to do it.
