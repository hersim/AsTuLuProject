...
$.extend($.validator, {
	...
	prototype: {
		...
		showErrors: function(errors) {
			...
			/// One or more key/value pairs of input names and mMessages.
			/// </param>
		...
		resetForm: function() {
			...
			/// indicating invalid elements and hides error mMessages.
			/// </summary>
		...
		// return the custom mMessage for the given element and validation method
		// specified in the element's "mMessages" metadata
		...
		// return the custom mMessage for the given element name and validation method
		...
		defaultMessage: function( element, method) {
			return this.findDefined(
				...
				"<strong>Warning: No mMessage defined for " + element.name + "</strong>"
			);
		},
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				// check if we have a generated label, replace the mMessage then
	...
	normalizeRules: function(rules, element) {
		...
		// To support custom mMessages in metadata ignore rule methods titled "mMessages"
		if (rules.messages) {
	...
	addMethod: function(name, method, message) {
		...
		/// identifier), a javascript based function and a default string mMessage.
		/// </summary>
		/// <param name="name" type="String">
		...
		/// </param>
		/// <param name="mMessage" type="String" optional="true">
		/// (Optional) The default mMessage to display for this method. Can be a function created by 
		/// jQuery.validator.format(value). When undefined, an already existing mMessage is used 
		/// (handy for localization), otherwise the field-specific mMessages have to be defined.
		/// </param>
