...
using UserProfile = AsTuLuWebProject.Models.UserProfile;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel _model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    UserAccount user = mUserRepository.GetUserByName(_model.UserName);

                    if (user == null)
                    {
                        mUserRepository.CreateUser(_model.UserName);
                    }
